...
import 'package:food_app_course_resto/screens/add_product.dart';
import 'package:food_app_course_resto/screens/orders.dart';
import 'package:food_app_course_resto/screens/product.dart';
   ...
   final userProvider = Provider.of<UserProvider>(context);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: CustomText(
          text: "Sales: Rs.${userProvider.totalSales}",
          color: white,
        ),
        actions: <Widget>[],
      ),
...
//                      )),
                  ...
                  Positioned.fill(
                      ...
                      child: Align(
                          alignment: Alignment.bottomLeft,
                          child: CustomText(
                            text: "Average Price: Rs.${userProvider.avgPrice}",
                            color: white,
                            size: 16,
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      onTap: (){
                        ...
                        trailing: CustomText(
                          text: productProvider.products.length.toString(),
                          size: 24,
                          weight: FontWeight.bold,
                        )),
                  ),
