...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final catrgoryProvider = Provider.of<CategoryProvider>(context);
              ...
              children: <Widget>[
                ...
                Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        CustomText(text: "Featured Product"),
                        Switch(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    DropdownButton<String>(
                      value: catrgoryProvider.selectedCategory,
                      style: TextStyle(
                      ...
                      elevation: 0,
                      onChanged: (value) {
                        catrgoryProvider.changeSelectedCategory(
                            newCategory: value.trim());
                      },
                      items: catrgoryProvider.catrgoriesNames
                      ...
                      child: FlatButton(
                        onPressed: () async {
                          ...
                          if (!await productProvider.uploadProduct(
                            category: catrgoryProvider.selectedCategory,
                            ...
                            _key.currentState.showSnackBar(SnackBar(
                              content: Text("Uploaded completed"),
                              duration: const Duration(seconds: 10),
                            ));
                            appProvider.changeLoading();
                            return;
